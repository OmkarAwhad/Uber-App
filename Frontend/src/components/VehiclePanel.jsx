...
const VehiclePanel = ({setConfirmRidePanel}) => {
	return (
		<div className="h-full">
			...
			<div onClick={()=>setConfirmRidePanel(true)} className="flex border-2 active:border-black h-fit  mb-2 rounded-xl w-full py-3 px-3 items-center justify-between">
			...
			<div onClick={()=>setConfirmRidePanel(true)} className="flex border-2 active:border-black mb-2 rounded-xl w-full py-3 px-3  items-center justify-between">
